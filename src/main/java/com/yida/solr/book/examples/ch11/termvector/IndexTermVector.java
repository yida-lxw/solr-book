package com.yida.solr.book.examples.ch11.termvector;
 ...
 *
 */
public class IndexTermVector {
    private static final String SOLR_INSTANT_CORE = "http://localhost:8080/solr/techproducts";
    private static final String XML_FILE_PATH = "E:/git-space/solr-book/example-docs/ch11/documents/mp500.xml";
