 ...
 * 跨Core Join查询12.3.1章节测试数据导入
 */
public class IndexAcrossCoreJoin {
    ...
    public static void main(String[] args) throws Exception {
        indexData("join_restaurants","join_restaurants.xml");
        indexData("join_useractions","join_useractions.xml");
    }
