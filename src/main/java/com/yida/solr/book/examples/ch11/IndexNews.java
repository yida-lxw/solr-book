...
public class IndexNews {
    private static final String SOLR_INSTANT_CORE = "http://localhost:8080/solr/news";
    private static final String XML_FILE_PATH = "E:/git-space/solr-book/example-docs/ch11/documents/news.xml";
